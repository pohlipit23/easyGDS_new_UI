...
import CountrySelect from 'src/components/common/country-select'
...
export const get_meta_default = (params) => {
  ...
  return computed(() => ({
    fields: compact([
      ...
      group === 'B2B' && props.node.meta.show_nationality && {
        id: PACKAGE_HOTEL_IDS.NATIONALITY,
        ...
        ...get_field_settings({
          field_id: PACKAGE_HOTEL_IDS.NATIONALITY,
          settings: field_setting,
          default_values: {
            order: {
              desktop: 4,
